...
* **myflexbox** pick-up machine
  ...
  * no account needed
  * A code will be sent to your e-mail address. The package will be available for collection for 3 calendar days. The pick-up machines are video-monitored. Only possible for packages up to 60 x 42 x 35 cm.
  * Shipping to a pseudonym is possible. If the package is delivered to a parcel shop instead and you are unable to pick it up there, it will take about 14 days for it to be returned until we can ship it again.
